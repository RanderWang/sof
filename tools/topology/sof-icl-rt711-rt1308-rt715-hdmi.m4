...
PIPELINE_PCM_DAI_ADD(sof/pipe-volume-playback.m4,
	4, 3, 2, s16le,
	1000, 0, 0, ALH, 0x202, s16le, 3,
	48000, 48000, 48000)

# Low Latency capture pipeline 5 on PCM 4 using max 2 channels of s16le.
# Schedule 48 frames per 1000us deadline on core 0 with priority 0
PIPELINE_PCM_DAI_ADD(sof/pipe-volume-capture.m4,
	5, 4, 2, s16le,
	1000, 0, 0, ALH, 0x302, s16le, 3,
	48000, 48000, 48000)
...
# Low Latency playback pipeline 6 on PCM 5 using max 2 channels of s16le.
# Schedule 48 frames per 1000us deadline on core 0 with priority 0
...
# Low Latency playback pipeline 7 on PCM 6 using max 2 channels of s16le.
# Schedule 48 frames per 1000us deadline on core 0 with priority 0
PIPELINE_PCM_ADD(sof/pipe-volume-playback.m4,
	7, 6, 2, s16le,
	1000, 0, 0,
...
# Low Latency playback pipeline 8 on PCM 7 using max 2 channels of s16le.
# Schedule 48 frames per 1000us deadline on core 0 with priority 0
PIPELINE_PCM_ADD(sof/pipe-volume-playback.m4,
	8, 7, 2, s16le,
	1000, 0, 0,
